...
@section('content-actions')
    <a href="{{route('products.index')}}"><i class='fas fa-arrow-left' style='font-size:25px;color:rgb(89, 83, 83)'></i></a>
@endsection
@section('css')
        ...
        <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="custom-file">
                    <input type="file" class="custom-file-input" value="{{ old('image', $product->image) }}" name="image" id="image">
